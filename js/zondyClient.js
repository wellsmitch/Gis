...
Zondy.Object.DynShowStyle = function (opt_options) {
    ...
    /// <summary>是否显示填充区</summary>
    this.FillReg = (options.FillReg !== undefined) ? options.FillReg : null;
};
/*----------------------------------------------------------------------------------------------------------------------------*/
...
Zondy.Format.PolygonJSON.prototype.parseVectors = function (zfeatureset) {
    ...
    if(zfeatureset.SFEleArray == null){
        return null;
    }
    ...
    for (var i = 0, len = zfeatureset.SFEleArray.length; i < len; i++) {
        ...
        var geometry;
        if (zfeature.fGeom) {
            geometry = this.parseGeometry(zfeature.fGeom, zfeature.ftype);
        }
...
Zondy.Format.PolygonJSON.prototype.parseAttribute = function (attstruct, attvalue) {
    ...
    if (attstruct == null || attvalue == null) {
        return null;
    }
...
/*----------------------------------------------Zondy.Format.PolygonJSON(end)---------------------------------------------------*/
//**********************************************************Zondy.Service.HttpRequest(start)************************************************//
...
///</param>
Zondy.Service.HttpRequest.prototype.ajax = function (restUrl, dataObject, onSuccess, type, contentType, resultFormat, onError, options,async) {
    if (restUrl == null) {
    ...
    if (this.ProxyHost != "") {
        this.ajaxForProxy(restUrl, dataObject, onSuccess, type, contentType, dataType, onError, options,async);
    }
    else {
        this.ajaxNormal(restUrl, dataObject, onSuccess, type, contentType, dataType, onError, options,async);
    }
};
...
Zondy.Service.HttpRequest.prototype.ajaxForProxy = function (restUrl, dataObject, onSuccess, type, contentType, dataType, onError, options,async) {
    ...
    var ajaxParam = {
        ...
        error: function (s) {
            if (Object.prototype.toString.call(onError) === '[object Function]') {
                ...
                console && console.log("请求失败，请检查参数");
            }
        }
    };
...
Zondy.Service.HttpRequest.prototype.ajaxNormal = function (restUrl, dataObject, onSuccess, type, contentType, dataType, onError, options,async) {
    var thisObj = this;
    var crossDomain = this.analysisCrossDomain(restUrl);
    //if ($.browser.msie && window.XDomainRequest && crossDomain) {
    var IEVersion = 0;
    if (navigator.userAgent.indexOf("MSIE") >= 0) {
        IEVersion = Number(navigator.userAgent.split("MSIE ")[1].split(";")[0]);
    }
    if (navigator.userAgent.indexOf("MSIE") >= 0 && window.XDomainRequest && crossDomain && IEVersion < 10) {
...
Zondy.Service.HttpRequest.prototype.ajaxForIE = function (url, data, callback, type, context, resultFormat, onError) {
    ...
    var onerror = function () {
        if (Object.prototype.toString.call(onError) === '[object Function]') {
            ...
            console && console.log("IE跨域请求请求失败");
        }
    };
    if (type.toUpperCase() == "GET") {
        var params = '';
...
Zondy.Service.Catalog.GDBInfo.prototype.getProjectList = function (onSuccess, onError, options) {
    ...
    /// <param name="onSuccess" type="Function">回调函数</param>
    this.partUrl = "datasource/" + this.serverName + "/" + this.gdbName + "?f=" + this.resultFormat + "&user=" + this.User + "&pwd=" + this.Password;
    this.ajax(null, null, onSuccess, "GET", null, null, onError, options);
};
...
Zondy.Service.Catalog.VectorLayer.prototype.getLayerInfo = function (gdbpUrl, onSuccess, onError, options, encryptPassword) {
    /// <summary>获取图层详细信息</summary>
    /// <param name="gdbpUrl" type="String">类URL</param>
    /// <param name="onSuccess" type="Function">回调函数</param>
    encryptPassword = encryptPassword || "";
    this.partUrl = "layerinfo?gdbpUrl=" + gdbpUrl + "&f=json&encryptPassword=" + encryptPassword + "&proj=" + this.proj;
    this.ajax(null, null, onSuccess, null, null, null, onError, options);
};
...
Zondy.Service.QueryParameterBase = function (opt_options) {
    ...
    /// 光标类型
    ///</summary>
    this.cursorType = options.cursorType !== undefined ? options.cursorType : "";
    /// <summary>
    /// 用户id
    ///</summary>
    this.guid = options.guid !== undefined ? options.guid : "";
    /// <summary>
    /// 过滤字段
    ///</summary>
    ...
    /// 时空云获取底图文档服务名称
    ///</summary>
    this.dataService = options.dataService !== undefined ? options.dataService : "";
    /// <summary>
    /// 图层索引号
    ///</summary>
    this.layerIdxs = options.layerIdxs !== undefined ? options.layerIdxs : "";
};
...
Zondy.Service.QueryParameter.prototype.getParameterURL = function () {
    ...
    if (this.struct != null) {
        paramUrl += "&structs=" + encodeURIComponent($.toJSON(this.struct));
    }
    if (this.where != null) {
        paramUrl += "&where=" + this.where;
    }
    if (this.rule != null) {
        paramUrl += "&rule=" + encodeURIComponent($.toJSON(this.rule));
    }
    ...
    if (this.dataService) {
        paramUrl += "&dataService=" + this.dataService;
    }
    if (this.layerIdxs) {
        paramUrl += "&layerIdxs=" + this.layerIdxs;
    }
    return paramUrl;
};
...
Zondy.Service.QueryParameter.prototype.getParameterObject = function () {
	...
	if(this.coordPrecision)
        obj.coordPrecision = this.coordPrecision;
    if (this.guid != null)
        obj.guid = this.guid;
    if (this.dataService != null)
        obj.dataService = this.dataService;
    if (this.layerIdxs != null)
        obj.layerIdxs = this.layerIdxs;
    return obj;
...
/// <summary>
///重载基类 getParameterObject ，获取相关参数的Object形式,私有方法
///</summary>
...
Zondy.Service.GetMapImageService = function (opt_options) {
    ...
    /// <summary>高质量显示{String}</summary>
    this.isAntialiasing = options.isAntialiasing !== undefined ? options.isAntialiasing : null;

    if (this.mapType == Zondy.Enum.Map.MapType.Tile) {
    ...
    if (this.mapName) {
        if (this.mapType == Zondy.Enum.Map.MapType.Tile) {
            this.partUrl = "map/" + this.mapName + "?"
                         ...
                         + "&row=" + this.row
                         + "&col=" + this.col
                         + "&isAntialiasing=" + this.isAntialiasing;
        }
        else {
            this.partUrl = "map/" + this.mapName + "?"
                         + "width=" + this.picWidth
...
Zondy.Service.GetLayerImageService.prototype.GetLayerImage = function () {
    if (this.gdbps != null && this.picWidth != null && this.picHeight != null) {
        ...
        if (this.isAntialiasing != null) {
            this.isAntialiasing += "&isAntialiasing=" + this.isAntialiasing;
        }
        this.partUrl += "&w=" + this.picWidth;
        this.partUrl += "&h=" + this.picHeight;
...
Zondy.Map.TileLayer = function (opt_name, opt_hdfName, opt_options) {
    ...
    if (this.source == null) {
        ...
        if (this.isAutoConfig) {
            var mService = new Zondy.Service.GetMapInfoService({ ip: options.ip, port: options.port, mapName: opt_hdfName, layerObj: this, paraObj: options, type: options.type || "" });
            ...
            }, function () { console && console.log("请求失败！"); }, null);
        }
        else {
            ...
            if (!this.cache) {
                if (options.tileData) {
                    ...
                    var resArr = data.resolutions;
                    if (data.startLevel > 0 && resArr && resArr.length > data.startLevel) {
                        for (var i = data.startLevel - 1; i >= 0; i--) {
                            if (resArr[i] < 1e-30 && resArr[i + 1] > 1e-30) {
...
Zondy.Source.MapDocSource.prototype.getImage = function (extent, resolution, pixelRatio, projection) {
    ...
    if (this.mode != null) {
        ol.obj.assign(params, { 'mode': this.mode });
    }
    //设置高质量显示
    if (this.isAntialiasing != null) {
        ol.obj.assign(params, { 'isAntialiasing': this.isAntialiasing });
    }
...
Zondy.Map.Doc.prototype.refresh = function () {
    ...
    if (this.isAntialiasing !== undefined && this.isAntialiasing !== null) {
        ol.obj.assign(this.options, { 'isAntialiasing': this.isAntialiasing });
    }
    this.source = new Zondy.Source.MapDocSource(this.options);
    this.setSource(this.source);
}
...
Zondy.Source.MapLayerSource.prototype.getImage = function (extent, resolution, pixelRatio, projection) {
    ...
    //设置投影参考系
    if (this.proj_ != undefined) {
        ol.obj.assign(params, { 'proj': this.proj_ });
    }
...
Zondy.Source.TiandituMapSource.prototype.tileUrlFunctionExtend = function (tileCoord, pixelRatio, projection) {
    ...
    if(this.custom !== null){
    	...
    	this.custom.layer = this.custom.layer ? this.custom.layer : "vec";
...
MilStd.tool.MilStdDrawTool = function (map) {
    ...
    this.featureOverLay.setZIndex(99999);
...
/**********************************************************标绘绘制（MilStd）end************************************************/
//**********************************************************Zondy.Service.MultiGeoQueryParameter(start)************************************************//
